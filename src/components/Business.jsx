    ...
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>You do the business, <br className="sm:block hidden" />
          well handle the money</h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5 mb-5, bill,google`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum voluptatibus suscipit mollitia libero, molestiae nam.
        </p>
